...
\includepdf[pages=-]{Bilder/Initialisation.pdf}

\includepdf[pages=-]{Bilder/haiti_calc.pdf}

\includepdf[pages=-]{Bilder/euler.pdf}

\includepdf[pages=-]{Bilder/eulersolve.pdf}
